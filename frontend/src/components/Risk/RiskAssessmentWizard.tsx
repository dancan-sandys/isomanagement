              ...
              <Grid item xs={12} md={4}>
                ...
                <Box sx={{ px: 2 }}>
                  <Slider
                    ...
                    onChange={(_, value) => updateAssessmentData('severity', value)}
                    step={1}
              ...
              <Grid item xs={12} md={4}>
                ...
                <Box sx={{ px: 2 }}>
                  <Slider
                    ...
                    onChange={(_, value) => updateAssessmentData('likelihood', value)}
                    step={1}
              ...
              <Grid item xs={12} md={4}>
                ...
                <Box sx={{ px: 2 }}>
                  <Slider
                    ...
                    onChange={(_, value) => updateAssessmentData('detectability', value)}
                    step={1}
