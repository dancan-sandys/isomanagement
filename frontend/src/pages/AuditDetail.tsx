            ...
            <TableBody>
              {attachments.map((att: any) => (
                <TableRow key={att.id}>
                  ...
                  <TableCell align="right">
                    <IconButton size="small" onClick={() => window.open(`${process.env.REACT_APP_API_URL || 'http://localhost:8000/api/v1'}/audits/attachments/${att.id}/download`, '_blank')}><AttachFile /></IconButton>
            ...
            <TableBody>
              {itemAttachments.map((att: any) => (
                <TableRow key={att.id}>
                  <TableCell>{att.filename}</TableCell>
                  <TableCell align="right">
                    <IconButton size="small" onClick={() => window.open(`${process.env.REACT_APP_API_URL || 'http://localhost:8000/api/v1'}/audits/checklist/attachments/${att.id}/download`, '_blank')}><AttachFile /></IconButton>
            ...
            <TableBody>
              {findingAttachments.map((att: any) => (
                <TableRow key={att.id}>
                  <TableCell>{att.filename}</TableCell>
                  <TableCell align="right">
                    <IconButton size="small" onClick={() => window.open(`${process.env.REACT_APP_API_URL || 'http://localhost:8000/api/v1'}/audits/findings/attachments/${att.id}/download`, '_blank')}><AttachFile /></IconButton>
