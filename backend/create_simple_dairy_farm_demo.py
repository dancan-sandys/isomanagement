#!/usr/bin/env python3
"""
Simple Dairy Farm Demo Data Creation
Populate the ISO 22000 FSMS platform with essential dairy farm data
"""
...
def create_simple_dairy_farm_demo():
    """Create simple dairy farm demo data"""
    print("🐄 Creating Simple Dairy Farm Demo Data")
    ...
    try:
        ...
        conn.commit()
        print("\n🎉 Simple Dairy Farm Demo Data Creation Completed Successfully!")
        print(f"\n📊 Demo Data Summary:")
...
if __name__ == "__main__":
    success = create_simple_dairy_farm_demo()
